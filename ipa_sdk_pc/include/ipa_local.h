 ...
 */
 ErrCode ipa_local__euicc_memory_reset( const euicc_memory_reset_request_t* euicc_memory_reset_request);
 ...
 * @return `eOk` on success, or an error code on failure.
 */
 ErrCode ipa_local__set_default_dp_address( const set_default_dp_address_request_t* set_default_dp_address_request);
 ...
 * @return `eOk` on success, or an error code on failure.
 */
 ErrCode ipa_local__add_initial_eim( const eim_config_t* eim_config_t);
 ...
 * @return `eOk` on success, or an error code on failure.
 */
 ErrCode ipa_local__configure_immediate_profile_enabling( const profile_enabling_config_t* profile_enabling_config);
